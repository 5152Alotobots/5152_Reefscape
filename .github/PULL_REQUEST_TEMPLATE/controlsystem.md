# Control System PR: [Feature Name]

## Description
<!-- Describe the control system changes -->
...
- [ ] All affected mechanisms verified
- [ ] All autonomous modes still functional
- [ ] Tested with network delay/drops (if networked)

## Driver Experience
- [ ] Driver team consulted on changes
...
- [ ] Schedule driver practice session
