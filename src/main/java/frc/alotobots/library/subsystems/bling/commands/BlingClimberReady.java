...
import static frc.alotobots.library.subsystems.bling.constants.BlingConstants.Animations.CLIMBER_READY_ANIMATION;

import edu.wpi.first.wpilibj2.command.Command;
import frc.alotobots.library.subsystems.bling.BlingSubsystem;

/** Command that displays the Climber Ready animation for 2 seconds. */
public class BlingClimberReady extends Command {
   ...
   */
  public BlingClimberReady(BlingSubsystem blingSubsystem) {
  ...
  public void initialize() {
    blingSubsystem.setAnimation(CLIMBER_READY_ANIMATION);
  }
