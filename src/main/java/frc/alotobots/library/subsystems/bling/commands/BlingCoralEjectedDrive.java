...
import static frc.alotobots.library.subsystems.bling.constants.BlingConstants.Animations.CORAL_EJECTED_DRIVE_ANIMATION;

import edu.wpi.first.wpilibj2.command.Command;
import frc.alotobots.library.subsystems.bling.BlingSubsystem;

/** Command that displays the Coral Ejected Drive animation for 2 seconds. */
public class BlingCoralEjectedDrive extends Command {
   ...
   */
  public BlingCoralEjectedDrive(BlingSubsystem blingSubsystem) {
  ...
  public void initialize() {
    blingSubsystem.setAnimation(CORAL_EJECTED_DRIVE_ANIMATION);
  }
