...
/**
 * A command that requests a position reset using AprilTag detection.
 * This command attempts to reset the robot's position estimation using detected AprilTags
 * through the LocalizationFusion subsystem.
 */
public class RequestPositionResetViaTags extends Command {
  ...
  /**
   * Executes the position reset request.
   * Attempts to reset the Oculus pose estimation using AprilTag detection.
   */
  @Override
  public void execute() {
