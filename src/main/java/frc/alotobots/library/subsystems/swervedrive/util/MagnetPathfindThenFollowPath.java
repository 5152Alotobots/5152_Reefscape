...
public class MagnetPathfindThenFollowPath extends Command {
    ...
    public void execute() {
        ...
        ChassisSpeeds blendedSpeeds = new ChassisSpeeds(
            ...
            hasRotInput ? driverSpeeds.omegaRadiansPerSecond : lastPathfindingSpeeds.omegaRadiansPerSecond
        );

        // Apply the blended speeds
        output.accept(blendedSpeeds, DriveFeedforwards.zeros(robotConfig.numModules));
        
        Logger.recordOutput("MagnetPathfind/BlendedSpeeds", new double[] {
    ...
    private void startNewPathfinding() {
        ...
        currentPath = new PathfindThenFollowPath(
            goalPath,
            constraints,
            poseSupplier,
            speedsSupplier,
