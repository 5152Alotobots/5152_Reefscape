 ...
 */
public class AutoStateL4 extends SequentialCommandGroup {
  /**
   ...
   */
  public AutoStateL4(ElevatorSubsystem elevatorSubsystem, WristSubsystem wristSubsystem) {
    addCommands(
        new LogCommand("State/State", "AUTO_CORAL_L4"),
