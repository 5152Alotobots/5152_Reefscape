...
/**
 * Command sequence for grabbing algae from the ground. The sequence: 1. Moves elevator and wrist to
 * position simultaneously 2. Runs intake
 */
public class StateAlgaeGround extends SequentialCommandGroup {
  ...
  public StateAlgaeGround(
    ...
    addCommands(
        new LogCommand("State/State", "ALGAE_GROUND"),
        new ParallelElevatorWristRun(
            elevatorSubsystem,
            wristSubsystem,
            ElevatorConstants.Setpoints.ALGAE_GROUND_PICKUP,
