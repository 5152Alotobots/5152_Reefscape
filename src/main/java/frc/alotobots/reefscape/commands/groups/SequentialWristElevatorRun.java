...
public class SequentialWristElevatorRun extends SequentialCommandGroup {
  /**
   * Creates a new SequentialWristElevatorRun command group that moves both the elevator and wrist
   * to specified positions one after the other. Runs the wrist first, then the elevator. Proxies
   * the commands to cede back to default command after runtime automatically.
   *
