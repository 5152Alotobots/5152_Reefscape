...
public final class ElevatorConstants {
  ...
  public static final class Setpoints {
    ...
    public static final Distance CORAL_CORAL_STATION = Meters.of(0.908);
