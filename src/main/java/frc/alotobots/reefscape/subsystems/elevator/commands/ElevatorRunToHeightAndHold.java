 ...
 * hold when the target height is reached within tolerance.
 */
public class ElevatorRunToHeightAndHold extends Command {
    ...
    /**
     * Creates a new ElevatorRunToHeightAndHold command.
     *
