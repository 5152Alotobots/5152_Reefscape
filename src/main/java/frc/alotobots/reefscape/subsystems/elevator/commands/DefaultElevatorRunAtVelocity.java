 ...
 * This command takes a velocity input (normalized between -1.0 and 1.0)
 * and applies it to the elevator, scaled by the maximum speed constant.
 */
public class DefaultElevatorRunAtVelocity extends Command {
    ...
    /**
     * Supplier for the input value that determines velocity direction and magnitude.
     * Expected range is between -1.0 and 1.0, where:
     * <ul>
     *   <li>Positive values move the elevator upward</li>
     *   <li>Negative values move the elevator downward</li>
     *   <li>Zero stops the elevator</li>
     * </ul>
     */
     ...
     * Calculates the target velocity by multiplying the input value by the maximum speed,
     * then commands the elevator subsystem to run at that velocity.
     */
    @Override
    public void execute() {
     ...
     * Stops the elevator to ensure it doesn't continue moving.
     *
     ...
     * This command never finishes on its own and will run until interrupted.
     *
