...
/**
 * Command that maintains the elevator's position at its current height.
 * This command uses closed-loop control to hold the elevator steady at whatever
 * height it was at when the command was initialized.
 */
public class ElevatorHoldHeight extends Command {
  ...
  /**
   * Initializes the command by setting the target position to the current height.
  ...
  /**
   * Executes the position holding control loop.
